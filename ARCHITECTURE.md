...
基本的には https://swagger.io/docs/specification/v3_0/paths-and-operations/ に沿ってください。

おすすめの手順としては

1. 先に jbuilder や jb でレスポンスを記述する
2. AIエージェントまたはAIエディタに 1 の内容をもとに JSON Schema を書かせる
3. 開発環境でエラーになるかを確認し、必要に応じて修正する
